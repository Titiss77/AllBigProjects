...
<div class="public-invitation fade-in" style="text-align: center; margin-bottom: 3rem;">
    ...
    <p style="color: var(--text-muted); font-size: 1.05rem; max-width: 600px; margin: 0 auto;">
        Naviguez via les onglets ci-dessus pour découvrir les liens, outils et recommandations partagés par la
        communauté <?php echo env('SITENAME'); ?>.
    </p>
</div>
<?php } else { ?>
                                                ...
                                                <div
                                                    ...
                                                    <span class="badge badge-episode">Ép. <span
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-sub="<?php echo htmlspecialchars($item->sous_categorie ?? ''); ?>">+1</button>
                                                        <?php } ?>
                                                    </span>
                                                </div>
                                                <?php } ?>
